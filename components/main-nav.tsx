...
export function MainNav() {
    ...
    return <nav className="flex items-center space-x-4 lg:space-x-6">
        ...
        <Link href="/contact" className={cn("text-sm font-medium transition-colors hover:text-primary hidden sm:inline-block", pathname === "/contact" ? "text-foreground" : "text-foreground/60")}>
            Contact
        </Link>
    </nav>
}